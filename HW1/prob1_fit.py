"""
Assignment 1: Problem 1 - Univariate Linear Regression
...
n_epoch = 60000 # number of epochs (full passes through the dataset)
...
def computeGrad(X, y, theta): 
	...
	dL_db = M*np.sum(y_hat - y) # derivative w.r.t. model weights b
	dL_dw = M*np.sum((y_hat - y)*X) # derivative w.r.t model bias w
...
#plt.savefig('prob_1_test_data.png')
...
#plt.savefig('prob_1_loss_vs_epochs.png')